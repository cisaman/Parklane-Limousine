...
class DriversController extends Controller {
    ...
    public function actionCreate() {
        ...
        if (isset($_POST['Drivers'])) {
            ...
            if ($model->save()) {
                ...
                Yii::app()->user->setFlash('message', Yii::t('lang', 'driver') . ' ' . Yii::t('lang', 'msg_add'));
            } else {
    ...
    public function actionUpdate($id) {
        ...
        if (isset($_POST['Drivers'])) {
            ...
            if ($model->save()) {
                Yii::app()->user->setFlash('type', 'success');
                Yii::app()->user->setFlash('message', Yii::t('lang', 'driver') . ' ' . Yii::t('lang', 'msg_update'));
            } else {
                Yii::app()->user->setFlash('type', 'danger');
                Yii::app()->user->setFlash('message', Yii::t('lang', 'msg_error'));
            }
    ...
    public function actionDelete($id) {
        ...
        if ($model->delete()) {
            if (!isset($_GET['ajax'])) {
                ...
                Yii::app()->user->setFlash('message', Yii::t('lang', 'driver') . ' ' . Yii::t('lang', 'msg_delete'));
            } else {
                echo '<div class="alert alert-success alert-dismissable" id="successmsg">' . Yii::t('lang', 'driver') . ' ' . Yii::t('lang', 'msg_delete') . '</div>';
            }
        }
    }
