<?php
$this->pageTitle = Yii::t('lang', 'parklane') . ' | Manage Pages';
...
<div class="row">
    <div class="col-lg-12">
        <div class="page-title">            
            <ol class="breadcrumb">
                <li><h1><i class="fa fa-user"></i> Manage Pages</h1></li>
            </ol>
        </div>
    </div>    
</div>
        ...
        <div class="portlet portlet-default">
            <div class="portlet-body">
                ...
                <ul id="userTab" class="nav nav-tabs">                    
                    <li class="active"><a href="#pages-list" data-toggle="tab">List of Pages</a></li>                    
                    <!--li class=""><a href="#pages-add" data-toggle="tab">Add Page</a></li-->
                </ul>
                                ...
                                <div class="table-responsive">
                                    ...
                                    $this->widget('zii.widgets.grid.CGridView', array(
                                        ...
                                        'columns' => array(
                                            ...
                                            array(
                                                'name' => 'pages_name_en',
                                                'value' => '$data->pages_name_en',
                                                'htmlOptions' => array('style' => 'text-align:justify;-ms-word-break: break-all;word-break: break-all;'),
                                                'filter' => CHtml::activeTextField($model, 'pages_name_en', array('placeholder' => $model->getAttributeLabel('pages_name_en'), 'style' => 'font-style:italic', 'autocomplete' => 'off', 'class' => 'form-control'))
                                            ),  
                                            array(
                                                'name' => 'pages_name_ch',
                                                'value' => '$data->pages_name_ch',
                                                'htmlOptions' => array('style' => 'text-align:justify;-ms-word-break: break-all;word-break: break-all;'),
                                                'filter' => CHtml::activeTextField($model, 'pages_name_ch', array('placeholder' => $model->getAttributeLabel('pages_name_ch'), 'style' => 'font-style:italic', 'autocomplete' => 'off', 'class' => 'form-control'))
                                            ),  
                                            array(
                                                'name' => 'pages_status',
                                                'value' => '($data->pages_status == 0) ? "Inactive" : "Active"',
                                                'htmlOptions' => array('style' => 'text-align:center;'),
                                                'headerHtmlOptions' => array('style' => 'text-align: center;width:120px'),
                                                'filter' => CHtml::activeDropDownList($model, 'pages_status', array(0 => 'Inactive', 1 => 'Active'), array('style' => 'font-style:italic', 'class' => 'form-control', 'empty' => 'Status'))
                                            ),
                                            array(
                                                'header' => 'Action',
                                                'class' => 'CButtonColumn',
