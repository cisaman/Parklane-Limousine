<div id="maincontent">
    ...
    Yii::app()->clientScript->registerScript('search', "
        $('.search-form form').submit(function(){
                $('#departure-grid').yiiGridView('update', {
                        data: $(this).serialize()
                });        
                return false;
        });
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="page-title">            
                <ol class="breadcrumb">
                    <li><h1><i class="fa fa-user"></i> <?php echo Yii::t('lang', 'manage') . ' ' . Yii::t('lang', 'airport_transfer') . ' ' . Yii::t('lang', 'service') . ' - ' . Yii::t('lang', 'departure'); ?></h1></li>
                </ol>
            </div>
        </div>    
    </div>
                                    ...
                                    $this->widget('zii.widgets.grid.CGridView', array(
                                        ...
                                        'columns' => array(
                                            ...
                                            array(
                                                ...
                                                'type' => 'raw',
                                                'value' => 'Booking::getCheckBoxForList(2, $data->booking_id)',
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $("#search_departurerecord").click(function () {
            ...
            var link = 'departure?Booking[booking_eta]=' + eta + '&Booking_page=2&ajax=Departure-grid';
        ...
        $("#search_departurereset").click(function () {
            ...
            var link = 'departure?ajax=Departure-grid&Booking_page=2';
