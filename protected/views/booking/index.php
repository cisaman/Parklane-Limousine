...
$('.search-form form').submit(function(){
	$('#" . $sub_service[1] . "-grid').yiiGridView('update', {
		data: $(this).serialize()
	});        
	return false;
});
$('.search-form form').submit(function(){
	$('#" . $sub_service[2] . "-grid').yiiGridView('update', {
		data: $(this).serialize()
	});        
	return false;
});
...
<div class="row">
    <div class="col-lg-12">
        <div class="page-title">            
            <ol class="breadcrumb">
                <li><h1><i class="fa fa-user"></i> <?php echo Yii::t('lang', 'manage') . ' ' . Yii::t('lang', 'airport_transfer') . ' ' . Yii::t('lang', 'service'); ?></h1></li>
            </ol>
        </div>
    </div>    
</div>
        ...
        <div class="portlet portlet-default">
            <div class="portlet-body">
                ...
                <ul id="userTab" class="nav nav-tabs">                    
                    <li class="active"><a id="listbox1" href="#<?php echo $sub_service[1]; ?>-list" data-toggle="tab"><?php echo Yii::t('lang', 'list_of') . ' ' . $sub_service[1]; ?></a></li>
                    <li class=""><a id="listbox2" href="#<?php echo $sub_service[2]; ?>-list" data-toggle="tab"><?php echo Yii::t('lang', 'list_of') . ' ' . $sub_service[2]; ?></a></li>
                </ul>
                <div id="userTabContent" class="tab-content">                    
                    <div class="tab-pane fade active in" id="<?php echo $sub_service[1]; ?>-list">
                    	<div class="row">
                            <div class="col-sm-9">
                                <div class="row">
                                    <div class="col-sm-1">
                                ...
                                <div class="table-responsive">
                                    ...
                                    $this->widget('zii.widgets.grid.CGridView', array(
                                        ...
                                        'columns' => array(
                                            ...
                                            array(
                                                ...
                                                'type' => 'raw',
                                                'value' => 'Booking::getCheckBoxForList(1)',
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 text-right">
                                            <input type="button" value="E-mail" class="btn btn-green"/>
                                            <input type="button" value="Confirm" class="btn btn-red"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="tab-pane" id="<?php echo $sub_service[2]; ?>-list">
                    	<div class="row">
                            <div class="col-sm-9">
                                <div class="row">
                                    <div class="col-sm-1">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="button" class="btn btn-success" id="search_departurerecord" value="Search" style="margin: 0px; line-height: 21px; width: 60px;"/>
                                        <input type="button" class="btn btn-danger" id="search_departurereset" value="Reset" style="margin: 0px; line-height: 21px; width: 60px;"/>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    $this->widget('zii.widgets.grid.CGridView', array(
                                        ...
                                        'columns' => array(
                                            ...
                                            array(
                                                ...
                                                'htmlOptions' => array('style' => 'text-align:center;-ms-word-break: break-all;word-break: break-all;'),
                                                'headerHtmlOptions' => array('style' => 'text-align: center;width:250px'),
                                                'filter' => CHtml::activeTextField($model, 'booking_eta', array('placeholder' => '拿起時間', 'style' => 'font-style:italic', 'autocomplete' => 'off', 'class' => 'form-control'))
                                            ),
                                            array(
                                                'name' => 'booking_districtID',
                                                'value' => 'District::model()->getDistrictName($data->booking_districtID)',
                                            ...
                                            array(
                                                'header' => '<input type="checkbox" id="selectAllDepartures"/>',
                                                'type' => 'raw',
                                                'value' => 'Booking::getCheckBoxForList(2)',
                                                'headerHtmlOptions' => array('style' => 'text-align: center;width:30px'),
                                                'htmlOptions' => array('style' => 'text-align:center;'),
                                            ),
                                        ),
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        // $('#Arrival-grid').find('table').wrap('<div class="sampleScroll"></div>');
        // $('#Departure-grid').find('table').wrap('<div class="sampleScroll"></div>');
        ...
        $('#selectAllDepartures').click(function(event) {
            if (this.checked) {
                $('.checkAllDepartures').each(function() {
                    this.checked = true;
                });
            } else {
                $('.checkAllDepartures').each(function() {
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $("#search_arrivalrecord").click(function () {            
            ...
            var link = 'index?Booking[booking_eta]=' + eta + '&Booking_page=1&ajax=Arrival-grid';
        ...
        $("#search_arrivalreset").click(function () {            
            ...
            var link = 'index?ajax=Arrival-grid&Booking_page=1';
        ...
        $("#search_departurerecord").click(function () {            
            ...
            var link = 'index?Booking[booking_eta]=' + eta + '&Booking_page=2&ajax=Departure-grid';
        ...
        $("#search_departurereset").click(function () {            
            $('#search_by_pickupdate').val('');
            
            var link = 'index?ajax=Departure-grid&Booking_page=2';
        ...
        $('#listbox1').click(function() {
           $("#search_arrivalreset").click();
        });

        $('#listbox2').click(function() {
            $("#search_departurereset").click();
        });
